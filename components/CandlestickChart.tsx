...
import { getCandlestickConfig, getChartConfig, PERIOD_BUTTONS, PERIOD_CONFIG, LIVE_INTERVAL_BUTTONS } from "@/constants";
            ...
            <div className="button-group">
                ...
                {PERIOD_BUTTONS.map(({value,label})=>(
                    <button key={value} className={period === value ?
                        'config-button-active' : 'config-button'} onClick={() => handlePeriodChange(value)}
                        disabled={isPending}>
                        {label}
                    </button>
                ))}
